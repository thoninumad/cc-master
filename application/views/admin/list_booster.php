                ...
                <ul class="nav metismenu" id="side-menu">
                    ...
                    <li >
                        ...
                        <ul class="nav nav-second-level">
                            ...
                            <li class="active"><a href="<?php echo base_url()?>admin/daftar_booster"><i class="	fa fa-paper-plane"></i> Daftar Booster</a></li>
                        </ul>
                    </li>
                </ul>
        ...
        <div class="wrapper wrapper-content animated fadeInRight">
            <div class="row wrapper white-bg page-heading" style="padding-top:20px">
                ...
                <tbody class="text-center">
                  <?php $a=count($booster);  $b=0; for ($i=0; $i < $a; $i++) { $b++; ?>
                  <tr>
                  <td style="width:3%"><?php echo $b?></td>
                  <td style="width:12%"><?php echo $booster[$i]->nopeg?></td>
                  <td style="width:12%"><?php echo $booster[$i]->nama_booster ?></td>
                  <td style="width:12%"><?php echo $booster[$i]->nama_unit?></td>
                  <td style="width:10%"><?php echo $booster[$i]->direktorat?></td>
                  <td style="width:10%"><?php if ($booster[$i]->status_aktif==1) echo "Aktif"; else echo "Tidak Aktif";?></td>
                  <td style="width:10%"><?php echo $booster[$i]->email?></td>
                  <td style="width:13%" class="text-center">
                                        <button type="button" class="btn btn-warning btn-xs table-hover" data-toggle="modal"  data-target="#<?php echo $booster[$i]->nopeg?>">Edit</button>
                                        <?=anchor( 'admin/delete_warrior/' . $booster[$i]->nopeg,
                                       'Delete',
                                       ...
                                       'onclick'=>'return confirm(\'Apakah Anda Yakin?\')'
                                                    ...
                                                    if($this->input->post('is_submitted')){
                                                                ...
                                                                $nopeg          = $booster[$i]->nopeg;
                                                                $unit           = $booster[$i]->unit;
                                                                $direktorat     = $booster[$i]->direktorat;
                                                                $status_aktif   = $booster[$i]->status_aktif;
                                                                $email          = $booster[$i]->email;
                                                    }
                                                    ?>
                                                        <!-- Modal -->
                                                    <div class="modal fade" id="<?php echo $booster[$i]->nopeg?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">

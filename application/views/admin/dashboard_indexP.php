        ...
        <div class="row border-bottom white-bg dashboard-header">
          <div class="row">
            <div class="col-md-12 col-sm-12 col-xs-12 widget_tally_box">
              ...
              <div class="x_title" style="text-align:center">
                <h2 >Index Pencapaian tiap Bagian</h2>
          ...
          <div class="col-md-12 col-sm-12 col-xs-12 widget_tally_box">
            <div class="x_panel" >
              ...
              <div class="x_title" style="text-align:center">
                <h2 style='font-weight: bold'>Direktorat</h2>
                <div class="clearfix"></div>
              </div>
              <div class="x_content">
              ...
              <div class="x_title" style="text-align:center">
                <h2 style='font-weight: bold'>Kantor Cabang</h2>
                <div class="clearfix"></div>
              </div>
              <div class="x_content">
              ...
              <div class="x_title" style="text-align:center">
                <h2 style='font-weight: bold'>Kantor Cabang Pembantu</h2>
                <div class="clearfix"></div>
              </div>
              <div class="x_content">
              ...
              <div class="x_title" style="text-align:center">
                <h2 style='font-weight: bold'>Kantor Kas</h2>
                <div class="clearfix"></div>
              </div>
              <div class="x_content">
                <div id="echart_gauge4" style="height:370px;"></div>
                <div style="text-align:center">
              ...
              <div class="x_title" style="text-align:center">
                <h2 style='font-weight: bold'>Kantor Cabang Syariah</h2>
                <div class="clearfix"></div>
              </div>
              <div class="x_content">
                <div id="echart_gauge5" style="height:370px;"></div>
                <div style="text-align:center">
              ...
              <div class="x_title" style="text-align:center">
                <h2 style='font-weight: bold'>Kantor Cabang Pembantu Syariah</h2>
                <div class="clearfix"></div>
              </div>
              <div class="x_content">
                <div id="echart_gauge6" style="height:370px;"></div>
                <div style="text-align:center">
...
<div class="row border-bottom white-bg dashboard-header">
    ...
    echartGauge.setOption({
      ...
      series: [{
        ...
        data: [{
          value: <?php echo number_format($progresdir[0]->progress,0,".","."); ?> ,
          name: 'Culture Progress'
        }]
      }]
    });
    ...
    echartGauge.setOption({
      ...
      series: [{
        ...
        data: [{
          value: <?php echo number_format($progreskc[0]->progress,0,".","."); ?> ,
          name: 'Culture Progress'
        }]
      }]
    });
    ...
    echartGauge.setOption({
      ...
      series: [{
        ...
        data: [{
          value: <?php echo number_format($progreskcp[0]->progress,0,".","."); ?> ,
          name: 'Culture Progress'
        }]
      }]
    });
    ...
    echartGauge.setOption({
      ...
      series: [{
        ...
        data: [{
          value: <?php echo number_format($progreskk[0]->progress,0,".","."); ?> ,
          name: 'Culture Progress'
        }]
      }]
    });
    ...
    echartGauge.setOption({
      ...
      series: [{
        ...
        data: [{
          value: <?php echo number_format($progreskcs[0]->progress,0,".","."); ?> ,
          name: 'Culture Progress'
        }]
      }]
    });
    ...
    echartGauge.setOption({
      ...
      series: [{
        ...
        data: [{
          value: <?php echo number_format($progreskcps[0]->progress,0,".","."); ?> ,
          name: 'Culture Progress'
        }]
      }]
    });
        ...
        Highcharts.chart('highgauge1', {
            ...
            series: [{
                ...
                data: [{
                    ...
                    radius: '112%',
                    innerRadius: '88%',
                    y: <?php echo number_format($progresdir[0]->progress,0,".","."); ?>
                }]
            }, {
                name: 'Cabang',
                data: [{
                    ...
                    radius: '87%',
                    innerRadius: '63%',
                    y: <?php echo number_format($progreskc[0]->progress,0,".","."); ?> 
                }]
            }, {
                name: 'Syariah',
                data: [{
                    ...
                    radius: '62%',
                    innerRadius: '38%',
                    y: <?php echo number_format($progreskcs[0]->progress,0,".","."); ?>
                }]
            }]
        });
    </script>

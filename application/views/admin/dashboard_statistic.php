            ...
            <div class="col-lg-12">
                <div class="widget red-bg p-lg text-center">
                            <div class="m-b-md">
                                ...
                                <h1 class="m-xs"><?php if(count($all) < 1){echo 0;}else{ echo count($all); } ?></h1>
          ...
          <div class="row"> 
            <div class="col-lg-4" >
                <div class="widget blue-bg p-lg text-center">
                            <div class="m-b-md">
                                <i class="fa fa-building fa-4x"></i>
                                <h1 class="m-xs"><?php if(count($alldir) < 1){echo 0;}else{ echo count($alldir); } ?></h1>
                                <h3 class="font-bold no-margins">
                                    Total Direktorat
                                </h3>
                            </div>
                ...
                <div class="widget blue-bg p-lg text-center">
                            <div class="m-b-md">
                                <i class="fa fa-building fa-4x"></i>
                                <h1 class="m-xs"><?php if(count($allkc) < 1){echo 0;}else{ echo count($allkc); } ?></h1>
                                <h3 class="font-bold no-margins">
                                    Total Kantor Cabang
                                </h3>
                            </div>
            ...
            <div class="col-lg-4" >
                <div class="widget blue-bg p-lg text-center">
                            <div class="m-b-md">
                                <i class="fa fa-building fa-4x"></i>
                                <h1 class="m-xs"><?php if(count($allkcp) < 1){echo 0;}else{ echo count($allkcp); } ?></h1>
                                <h3 class="font-bold no-margins">
                ...
                <div class="widget blue-bg p-lg text-center">
                            <div class="m-b-md">
                                <i class="fa fa-building fa-4x"></i>
                                <h1 class="m-xs"><?php if(count($allkk) < 1){echo 0;}else{ echo count($allkk); } ?></h1>
                                <h3 class="font-bold no-margins">
                                    Total Kantor Kas
                                </h3>
                            </div>
            ...
            <div class="col-lg-4" >
                <div class="widget blue-bg p-lg text-center">
                            <div class="m-b-md">
                                <i class="fa fa-building fa-4x"></i>
                                <h1 class="m-xs"><?php if(count($allkcs) < 1){echo 0;}else{ echo count($allkcs); } ?></h1>
                                <h3 class="font-bold no-margins">
                ...
                <div class="widget blue-bg p-lg text-center">
                            <div class="m-b-md">
                                ...
                                <h1 class="m-xs"><?php if(count($allkcps) < 1){echo 0;}else{ echo count($allkcps); } ?></h1>
                                <h3 class="font-bold no-margins">
                                    Total Kantor Cabang Pembantu Syariah
                                </h3>
                            </div>
                 </div>
            </div>

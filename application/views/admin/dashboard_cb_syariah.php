                ...
                <ul class="nav metismenu" id="side-menu">
                    ...
                    <li class="active">
                        ...
                        <ul class="nav nav-second-level">
                            ...
                            <li class="active"><a href="<?php echo base_url()?>admin/dashboard_cb_syariah"><i class="fa fa-area-chart"></i> Dashboard Cabang Utama Syariah</a></li>
          ...
          <div class="row">
            <div class="col-md-12 col-sm-12 col-xs-12 widget_tally_box">
              ...
              <div class="x_title" style="text-align:center">
                <h2 >Index Pencapaian Kantor Cabang Syariah</h2>
            ...
            <div class="col-lg-6">
             ...
             <div class="col-lg-6" id="divprint">
                <div class="ibox float-e-margins">     
                                ...
                                <button type="button" class="btn btn-default btn-xs table-hover" data-toggle="modal"  data-target="#lihat_barchart">View on Bar Chart</button> <a class="btn btn-default btn-xs table-hover" href="<?php echo base_url()?>admin/printradar/KCS" target="_blank"><i class="fa fa-print"></i> Print</a>
                        </div>
            </div>
          </div>
        </div>      
                                                      ...
                                                      <div class="modal-dialog modal-lg" role="document">
                                                        <div class="modal-content">
                                                          ...
                                                          <div class="modal-body">
                                                                ...
                                                                <div class="box-body">
                                                                <div class="row">
                                                                    <a class="btn btn-success" href="<?php echo base_url()?>admin/printbar/KCS" target="_blank"><i class="fa fa-print"></i> Print</a>
                                                                </div>
                                                                <div class="row">
            ...
            <div class="row border-bottom white-bg dashboard-header">
                  <div class="row">
                    <div class="col-md-12 col-sm-12 col-xs-12 widget_tally_box">
                      ...
                      <div class="x_title" style="text-align:center">
                        <h2 >Tingkat Pencapaian Tiap Kantor Cabang Syariah</h2><br/>
                        <div class="clearfix"></div>
                      </div>
                    </div>
                  </div>
...
<!--           $queries2=mysqli_query($con,"SELECT AVG(input_realisasi_) as rata2 FROM cc_program_eval JOIN cc_program_input on cc_program_eval.input_user_c=cc_program_input.input_user  and cc_program_input.input_detail=cc_program_eval.input_detail_c where input_user='".$row['unit_name']."' and input_bulan='".$bulan."'");-->
    ...
    echartGauge.setOption({
      ...
      series: [{
        ...
        data: [{
          value: <?php echo number_format($avgsyariah[0]->progress,0,".","."); ?> ,
          name: 'Corporate Progress'
        }]
      }]
    });
...
<script type="text/javascript">
    $(function () {
        var radarData = {
        labels: [
                <?php foreach ($progresdsyariah as $a) { ?>

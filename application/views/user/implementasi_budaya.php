                      ...
                      <li><a href="<?php echo base_url()?>user"><button type="button" class="btn btn-primary">Back</button></a></li>
                        ...
                        <div class="modal fade" id="isitim" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
                                ...
                                <div class="form-group">
                                  ...
                                  <div class="col-md-6 col-sm-6 col-xs-12">
                                    <input type="email" id="first-name" required name="email" class="form-control col-md-7 col-xs-12">
                                  </div>
                                </div>
                                <div class="form-group">
                                ...
                                <!-- <div class="form-group">
                                  <label class="control-label col-md-3 col-sm-3 col-xs-12" for="first-name">Jabatan Lain
                                  </label>
                                  <div class="col-md-6 col-sm-6 col-xs-12">
                                    <select class="form-control" required="true" name="status_aktif">
                                        <option value="x">Choose..</option>
                                        <option value="1">Warrior</option>
                                        <option value="0">Booster</option>
                                    </select>
                                  </div>
                                </div> -->
                  ...
                  <div class="x_panel ui-ribbon-container ">
                          <div class="x_content">
                                ...
                                <?php $a=count($warrior);  $b=0; for ($i=0; $i < $a; $i++) {
                                  ...
                                  ?>
                               <?php if($nopeg == 0){ ?>
                                      <p>Belum memiliki Tim Implementasi Budaya</p>
                              <?php    } else {?>

                ...
                <ul class="nav metismenu" id="side-menu">
                    ...
                    <li class="active">
                        ...
                        <ul class="nav nav-second-level">
                            ...
                            <li class="active"><a href="<?php echo base_url()?>admin/dashboard_botEx"><i class="	fa fa-line-chart"></i> Dashboard Bottom Execution</a></li>
                        </ul>
                    </li>
                    <li >
          ...
          <div class="row">
            <div class="col-md-12 col-sm-12 col-xs-12 widget_tally_box">
              ...
              <div class="x_title" style="text-align:center">
                <h2 >Bottom 3 Culture Execution</h2>
                ...
                <div class="x_panel">
                  <div class="x_title">
                    <h2 style='font-weight: bold'>Bottom 3 Kantor Pusat</h2>
                    <div class="clearfix"></div>
                  </div>
                  <div class="x_content">
                    ...
                    <table class="table table-hover table-bordered" style="font-size:14px">
                      ...
                      <tbody>       
                              ...
                              <td style="text-align:center" >
                              <?php echo $botDV[0]->kode_unit; ?>
                              </td>
                                  <td style="text-align:center" >
                                    <?php echo substr($botDV[0]->nama_unit,0,35); ?>
                                </td>
                              <td style="text-align:center" >
                              <?php echo $botDV[0]->total_score; ?> 
                              </td>
                            </tr>
                            ...
                            <tr>
                              ...
                              <td style="text-align:center" >
                              <?php echo $botDV[1]->kode_unit; ?>
                              </td>
                                <td style="text-align:center" >
                                <?php echo substr($botDV[1]->nama_unit,0,35); ?>
                                 </td>
                              <td style="text-align:center" >
                              <?php echo $botDV[1]->total_score; ?>  
                              </td>
                            </tr>
                            ...
                            <tr>
                              ...
                              <td style="text-align:center" >
                              <?php echo $botDV[2]->kode_unit; ?>
                              </td>
                                <td style="text-align:center" >
                                <?php echo substr($botDV[2]->nama_unit,0,35); ?>
                                </td>
                              <td style="text-align:center" >
                              <?php echo $botDV[2]->total_score; ?>  
                              </td>
                            </tr>
                                            ...
                                            <div class="modal-dialog">
                                                <div class="modal-content animated bounceInRight">
                                                    <div class="modal-header">
                                                        ...
                                                        <h4 class="modal-title">Head Office Bottomboard</h4>
                                                    ...
                                                    <div class="modal-body">
                                                        ...
                                                        <tbody>       
                                                                ...
                                                                <td style="text-align:center" >
                                                                <?php echo $botDV[$i]->kode_unit; ?>
                                                                </td>
                                                                      <td style="text-align:center" >
                                                                      <?php echo $botDV[$i]->nama_unit; ?>
                                                                      </td>
                                                                <td style="text-align:center" >
                                                                <?php echo $botDV[$i]->total_score; ?> 
                                                                </td>
                                                              </tr>
              ...
              <div class="col-md-4 col-sm-4    col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2 style='font-weight: bold'>Bottom 3 Kantor Cabang</h2>
                    <div class="clearfix"></div>
                  </div>
                  <div class="x_content">
                    ...
                    <table class="table table-hover table-bordered" style="font-size:14px">
                      ...
                      <tbody>       
                              ...
                              <td style="text-align:center" >
                              <?php echo $botKC[0]->kode_unit; ?>
                              </td>
                                  <td style="text-align:center" >
                              <?php echo substr($botKC[0]->nama_unit,0,35); ?>
                              </td>
                              <td style="text-align:center" >
                              <?php echo $botKC[0]->total_score; ?>  
                              </td>
                            </tr>
                            ...
                            <tr>
                              ...
                              <td style="text-align:center" >
                              <?php echo $botKC[1]->kode_unit; ?>  
                              </td>
                                <td style="text-align:center" >
                              <?php echo substr($botKC[1]->nama_unit,0,20); ?>
                              </td>
                              <td style="text-align:center" >
                              <?php echo $botKC[1]->total_score; ?>  
                              </td>
                            </tr>
                            ...
                            <tr>
                              ...
                              <td style="text-align:center" >
                              <?php echo $botKC[2]->kode_unit; ?>  
                              </td>
                                <td style="text-align:center" >
                              <?php echo substr($botKC[2]->nama_unit,0,35); ?>
                              </td>
                              <td style="text-align:center" >
                              <?php echo $botKC[2]->total_score; ?>  
                              </td>
                            </tr>
                                            ...
                                            <div class="modal-dialog">
                                                <div class="modal-content animated bounceInRight">
                                                    <div class="modal-header">
                                                        ...
                                                        <i class="fa fa-laptop modal-icon"></i>
                                                        <h4 class="modal-title">Branch Office Bottomboard</h4>
                                                    ...
                                                    <div class="modal-body">
                                                        ...
                                                        <tbody>                                                                 
                                                                ...
                                                                <td style="text-align:center" >
                                                                <?php echo $botKC[$i]->kode_unit; ?>
                                                                </td>
                                                                    <td style="text-align:center" >
                                                                      <?php echo $botKC[$i]->nama_unit; ?>
                                                                      </td>
                                                                <td style="text-align:center" >
                                                                <?php echo $botKC[$i]->total_score; ?> 
                                                                </td>
                                                              </tr>
                ...
                <div class="x_panel">
                  <div class="x_title">
                    <h2 style='font-weight: bold'>Bottom 3 Kantor Cabang Syariah</h2>
                    <div class="clearfix"></div>
                  </div>
                  <div class="x_content">
                    ...
                    <table class="table table-hover table-bordered" style="font-size:14px">
                      ...
                      <tbody>       
                              ...
                              <td style="text-align:center" >
                              <?php echo $botKCS[0]->kode_unit; ?>
                              </td>
                                  <td style="text-align:center" >
                              <?php echo substr($botKCS[0]->nama_unit,0,35); ?>
                              </td>
                              <td style="text-align:center" >
                              <?php echo $botKCS[0]->total_score; ?>  
                              </td>
                            </tr>
                            ...
                            <tr>
                              ...
                              <td style="text-align:center" >
                              <?php echo $botKCS[1]->kode_unit; ?>  
                              </td>
                                <td style="text-align:center" >
                              <?php echo substr($botKCS[1]->nama_unit,0,35); ?>
                              </td>
                              <td style="text-align:center" >
                              <?php echo $botKCS[1]->total_score; ?>  
                              </td>
                            </tr>
                            ...
                            <tr>
                              ...
                              <td style="text-align:center" >
                              <?php echo $botKCS[2]->kode_unit; ?>  
                              </td>
                                <td style="text-align:center" >
                              <?php echo substr($botKCS[2]->nama_unit,0,35); ?>
                              </td>
                              <td style="text-align:center" >
                              <?php echo $botKCS[2]->total_score; ?>  
                              </td>
                            </tr>
                                            ...
                                            <div class="modal-dialog">
                                                <div class="modal-content animated bounceInRight">
                                                    <div class="modal-header">
                                                        ...
                                                        <i class="fa fa-laptop modal-icon"></i>
                                                        <h4 class="modal-title">Syariah Branch Office Bottomboard</h4>
                                                    ...
                                                    <div class="modal-body">
                                                        ...
                                                        <tbody>                                                                 
                                                                ...
                                                                <td style="text-align:center" >
                                                                <?php echo $botKCS[$i]->kode_unit; ?>
                                                                </td>
                                                                    <td style="text-align:center" >
                                                                      <?php echo $botKCS[$i]->nama_unit; ?>
                                                                      </td>
                                                                <td style="text-align:center" >
                                                                <?php echo $botKCS[$i]->total_score; ?> 
                                                                </td>
                                                              </tr>
             ...
             <div class="col-md-4 col-sm-4    col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2 style='font-weight: bold'>Bottom 3 Kantor Cabang Pembantu</h2>
                    <div class="clearfix"></div>
                  </div>
                  <div class="x_content">
                    ...
                    <table class="table table-hover table-bordered" style="font-size:14px">
                      ...
                      <tbody>       
                              ...
                              <td style="text-align:center" >
                              <?php echo $botKCP[0]->kode_unit; ?>
                              </td>
                                  <td style="text-align:center" >
                                    <?php echo substr($botKCP[0]->nama_unit,0,35); ?>
                                </td>
                              <td style="text-align:center" >
                              <?php echo $botKCP[0]->total_score; ?> 
                              </td>
                            </tr>
                            ...
                            <tr>
                              ...
                              <td style="text-align:center" >
                              <?php echo $botKCP[1]->kode_unit; ?>
                              </td>
                                <td style="text-align:center" >
                                <?php echo substr($botKCP[1]->nama_unit,0,35); ?>
                                 </td>
                              <td style="text-align:center" >
                              <?php echo $botKCP[1]->total_score; ?>  
                              </td>
                            </tr>
                            ...
                            <tr>
                              ...
                              <td style="text-align:center" >
                              <?php echo $botKCP[2]->kode_unit; ?>
                              </td>
                                <td style="text-align:center" >
                                <?php echo substr($botKCP[2]->nama_unit,0,35); ?>
                                </td>
                              <td style="text-align:center" >
                              <?php echo $botKCP[2]->total_score; ?>  
                              </td>
                            </tr>
                                                ...
                                                <div class="modal-content animated bounceInRight">
                                                    ...
                                                    <div class="modal-body">
                                                        ...
                                                        <tbody>       
                                                                ...
                                                                <td style="text-align:center" >
                                                                <?php echo $botKCP[$i]->kode_unit; ?>
                                                                </td>
                                                                      <td style="text-align:center" >
                                                                      <?php echo $botKCP[$i]->nama_unit; ?>
                                                                      </td>
                                                                <td style="text-align:center" >
                                                                <?php echo $botKCP[$i]->total_score; ?> 
                                                                </td>
                                                              </tr>
              ...
              <div class="col-md-4 col-sm-4    col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2 style='font-weight: bold'>Bottom 3 Kantor Kas</h2>
                    <div class="clearfix"></div>
                  </div>
                  <div class="x_content">
                    ...
                    <table class="table table-hover table-bordered" style="font-size:14px">
                      ...
                      <tbody>       
                              ...
                              <td style="text-align:center" >
                              <?php echo $botKK[0]->kode_unit; ?>
                              </td>
                                  <td style="text-align:center" >
                              <?php echo substr($botKK[0]->nama_unit,0,35); ?>
                              </td>
                              <td style="text-align:center" >
                              <?php echo $botKK[0]->total_score; ?>  
                              </td>
                            </tr>
                            ...
                            <tr>
                              ...
                              <td style="text-align:center" >
                              <?php echo $botKK[1]->kode_unit; ?>  
                              </td>
                                <td style="text-align:center" >
                              <?php echo substr($botKK[1]->nama_unit,0,35); ?>
                              </td>
                              <td style="text-align:center" >
                              <?php echo $botKK[1]->total_score; ?>  
                              </td>
                            </tr>
                            ...
                            <tr>
                              ...
                              <td style="text-align:center" >
                              <?php echo $botKK[2]->kode_unit; ?>  
                              </td>
                                <td style="text-align:center" >
                              <?php echo substr($botKK[2]->nama_unit,0,35); ?>
                              </td>
                              <td style="text-align:center" >
                              <?php echo $botKK[2]->total_score; ?>  
                              </td>
                            </tr>
                                            ...
                                            <div class="modal-dialog">
                                                <div class="modal-content animated bounceInRight">
                                                    <div class="modal-header">
                                                        ...
                                                        <i class="fa fa-laptop modal-icon"></i>
                                                        <h4 class="modal-title">Kas Office Bottomboard</h4>
                                                    ...
                                                    <div class="modal-body">
                                                        ...
                                                        <tbody>                                                                 
                                                                ...
                                                                <td style="text-align:center" >
                                                                <?php echo $botKK[$i]->kode_unit; ?>
                                                                </td>
                                                                    <td style="text-align:center" >
                                                                      <?php echo $botKK[$i]->nama_unit; ?>
                                                                      </td>
                                                                <td style="text-align:center" >
                                                                <?php echo $botKK[$i]->total_score; ?> 
                                                                </td>
                                                              </tr>
                ...
                <div class="x_panel">
                  <div class="x_title">
                    <h2 style='font-weight: bold'>Bottom 3 Kantor Cabang Pembantu Syariah</h2>
                    <div class="clearfix"></div>
                  </div>
                  <div class="x_content">
                    ...
                    <table class="table table-hover table-bordered" style="font-size:14px">
                      ...
                      <tbody>       
                              ...
                              <td style="text-align:center" >
                              <?php echo $botKCPS[0]->kode_unit; ?>
                              </td>
                                  <td style="text-align:center" >
                              <?php echo substr($botKCPS[0]->nama_unit,0,35); ?>
                              </td>
                              <td style="text-align:center" >
                              <?php echo $botKCPS[0]->total_score; ?>  
                              </td>
                            </tr>
                            ...
                            <tr>
                              ...
                              <td style="text-align:center" >
                              <?php echo $botKCPS[1]->kode_unit; ?>  
                              </td>
                                <td style="text-align:center" >
                              <?php echo substr($botKCPS[1]->nama_unit,0,35); ?>
                              </td>
                              <td style="text-align:center" >
                              <?php echo $botKCPS[1]->total_score; ?>  
                              </td>
                            </tr>
                            ...
                            <tr>
                              ...
                              <td style="text-align:center" >
                              <?php echo $botKCPS[2]->kode_unit; ?>  
                              </td>
                                <td style="text-align:center" >
                              <?php echo substr($botKCPS[2]->nama_unit,0,35);?>
                              </td>
                              <td style="text-align:center" >
                              <?php echo $botKCPS[2]->total_score; ?>  
                              </td>
                            </tr>
                                                ...
                                                <div class="modal-content animated bounceInRight">
                                                    ...
                                                    <div class="modal-body">
                                                        ...
                                                        <tbody>                                                                 
                                                                ...
                                                                <td style="text-align:center" >
                                                                <?php echo $botKCPS[$i]->kode_unit; ?>
                                                                </td>
                                                                    <td style="text-align:center" >
                                                                      <?php echo $botKCPS[$i]->nama_unit; ?>
                                                                      </td>
                                                                <td style="text-align:center" >
                                                                <?php echo $botKCPS[$i]->total_score; ?> 
                                                                </td>
                                                              </tr>

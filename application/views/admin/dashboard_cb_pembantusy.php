                ...
                <ul class="nav metismenu" id="side-menu">
                    ...
                    <li class="active">
                        ...
                        <ul class="nav nav-second-level">
                            ...
                            <li class="active"><a href="<?php echo base_url()?>admin/dashboard_cb_pembantusy"><i class="fa fa-area-chart"></i> Dashboard Cabang Pembantu Syariah</a></li>
                        </ul>
                    </li>
                   <li >
          ...
          <div class="row">
            <div class="col-md-12 col-sm-12 col-xs-12 widget_tally_box">
              ...
              <div class="x_title" style="text-align:center">
                <h2 >Index Pencapaian Kantor Cabang Pembantu Syariah</h2>
            ...
            <div class="col-lg-6">
             ...
             <div class="col-lg-6" id="divprint">
                <div class="ibox float-e-margins">     
                                ...
                                <button type="button" class="btn btn-default btn-xs table-hover" data-toggle="modal"  data-target="#lihat_barchart">View on Bar Chart</button> <a class="btn btn-default btn-xs table-hover" href="<?php echo base_url()?>admin/printradar/KCPS" target="_blank"><i class="fa fa-print"></i> Print</a>
                        </div>
            </div>
          </div>
        </div>      
                                                      ...
                                                      <div class="modal-dialog modal-lg" role="document">
                                                        <div class="modal-content">
                                                          ...
                                                          <div class="modal-body">
                                                                ...
                                                                <div class="box-body">
                                                                <div class="row">
                                                                    <a class="btn btn-success" href="<?php echo base_url()?>admin/printbar/KCPS" target="_blank"><i class="fa fa-print"></i> Print</a>
                                                                </div>
                                                                <div class="row">
                                                                  
                                                                     <div id="barcharts" style="min-width: 310px; max-width: 800px; height: 500; margin: 0 auto"></div>
            ...
            <div class="row border-bottom white-bg dashboard-header">
                  <div class="row">
                    <div class="col-md-12 col-sm-12 col-xs-12 widget_tally_box">
                      ...
                      <div class="x_title" style="text-align:center">
                        <h2 >Tingkat Pencapaian Tiap Kantor Cabang Pembantu Syariah</h2><br/>
                        <div class="clearfix"></div>
                      </div>
                    </div>
                  </div>
                            ...
                            <div class="ibox-content">
                                <div>
                                    <h3 class="font-bold no-margins">
                                        Tingkat Pencapaian Tiap Kantor Cabang Syariah
                                    </h3>
            ...
            <div class="panel panel-default">
              <div class="panel-heading">
                <h4 class="panel-title">
                  <a data-toggle="collapse" data-parent="#accordion" href="#collapse">Kantor Cabang Syariah</a>
                </h4>
              </div>
...
<!--           $queries2=mysqli_query($con,"SELECT AVG(input_realisasi_) as rata2 FROM cc_program_eval JOIN cc_program_input on cc_program_eval.input_user_c=cc_program_input.input_user  and cc_program_input.input_detail=cc_program_eval.input_detail_c where input_user='".$row['unit_name']."' and input_bulan='".$bulan."'");-->
    ...
    echartGauge.setOption({
      ...
      series: [{
        ...
        data: [{
          value: <?php echo number_format($avgpsyariah[0]->progress,0,".","."); ?> ,
          name: 'Corporate Progress'
        }]
      }]
    });
...
<script type="text/javascript">
    $(function () {
        var radarData = {
        labels: [
                <?php foreach ($progresdpsyariah as $a) { ?>

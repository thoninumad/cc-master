    ...
    <div id="wrapper">
          ...
          <div class="row">
            <div class="col-md-12 col-sm-12 col-xs-12 widget_tally_box">
              ...
              <div class="x_title" style="text-align:center">
                <h2 >Index Pencapaian Direktorat</h2>
      ...
      <div class="container-fluid border-bottom white-bg dashboard-header">
          <div class="row"> 
            <div class="col-lg-6">
                 <div class="x_title" style="text-align:center">
                <h2 style='font-weight: bold'>Tingkat Pencapaian Direktorat</h2>
                <div class="clearfix"></div>
              </div>
              <div class="x_content">
            ...
            <div class="col-lg-6" id="divprint">
                <div class="ibox float-e-margins">     
                                <h2><b>Tingkat Pencapaian Per Direktorat</b></h2>
                                <br/>
                                <div>
                                    <canvas id="radarChart"></canvas>
                                </div>
                                <button type="button" class="btn btn-default btn-xs table-hover" data-toggle="modal"  data-target="#lihat_barchart">View on Bar Chart</button> <a class="btn btn-default btn-xs table-hover" href="<?php echo base_url()?>admin/printradar/1" target="_blank"><i class="fa fa-print"></i> Print</a>
                        </div>
            </div>
          </div>
        </div>      
                                                      ...
                                                      <div class="modal-dialog modal-lg" role="document">
                                                        <div class="modal-content">
                                                          ...
                                                          <div class="modal-body">
                                                                ...
                                                                <div class="box-body">
                                                                <div class="row">
                                                                    <a class="btn btn-success" href="<?php echo base_url()?>admin/printbar/1" target="_blank"><i class="fa fa-print"></i> Print</a>
                                                                </div>
                                                                <div class="row">
                                                                  
                                                                     <div id="barcharts" style="min-width: 310px; max-width: 800px;  margin: 0 auto"></div>
            ...
            <div class="row border-bottom white-bg dashboard-header">
                  <div class="row">
                    <div class="col-md-12 col-sm-12 col-xs-12 widget_tally_box">
                      ...
                      <div class="x_title" style="text-align:center">
                        <h2 >Tingkat Pencapaian Tiap Direktorat</h2><br/>
                        <div class="clearfix"></div>
                      </div>
                    </div>
                  </div>
                            ...
                            <div class="ibox-content">
                                <div>
                                    <h3 class="font-bold no-margins">
                                        Tingkat Pencapaian Implementasi
                                    </h3>
                                ...
                                <div class="m-t-sm">
                                    <div class="row">    
                                        <?php 
                                        foreach ($progresdivisiOverall as $x) { 
                                        ?>
                                        ...
                                        <div class="col-xs-2 col-md-2 text-center">
                                            <input type="text" class="knob"                                             
                                                ...
                                                data-fgColor= "#4286f4"
                                                data-readonly="true">                  
                                            <div class="knob-label"><?php echo substr($x->kode_dir,9,30) ?></div><br/><br/>
                                        </div>
                                         <?php } ?>                               
                                    </div>
                                </div>
            ...
            <div class="panel panel-default">
              <div class="panel-heading">
                <h4 class="panel-title">
                  <a data-toggle="collapse" data-parent="#accordion" href="#collapse">Kantor Pusat</a>
                </h4>
              </div>

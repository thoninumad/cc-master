                ...
                <ul class="nav metismenu" id="side-menu">
                    ...
                    <li >
                        ...
                        <ul class="nav nav-second-level">
                            ...
                            <li class="active"><a href="<?php echo base_url()?>admin/daftar_tib"><i class="	fa fa-shield"></i> Daftar TIB</a></li>
        ...
        <div class="row border-bottom">
          ...
          <div class="navbar-header">
            ...
            <div class="row wrapper border-bottom white-bg page-heading">
                <div class="col-lg-9">
                    <h2>List Tim Implementasi Budaya</h2>
                    <ol class="breadcrumb">
                        <li>
                            <a href="<?php echo base_url()?>admin">Home</a>
                        </li>
                        <li class="active">
                            <strong>List Tim Implementasi Budaya</strong>
                        </li>
                    </ol>
                </div>
            </div>
            ...
            <div class="row wrapper white-bg page-heading" style="padding-top:20px">
                ...
                <thead>
                        <tr class="headings">
                          ...
                          <th class="text-center" style="width:5%">Posisi</th>
                ...
                <tbody class="text-center">
                  <?php $a=count($tib);  $b=0; for ($i=0; $i < $a; $i++) { $b++; ?>
                  <tr>
                  <td style="width:3%"><?php echo $b?></td>
                  <td style="width:12%"><?php echo $tib[$i]->nopeg?></td>
                  <td style="width:12%"><?php echo $tib[$i]->nama?></td>
                  <td style="width:12%"><?php echo $tib[$i]->posisi?></td>
                  <td style="width:12%"><?php echo $tib[$i]->nama_unit ?></td>
                  <td style="width:10%"><?php echo $tib[$i]->direktorat?></td>
                  <td style="width:10%"><?php if ($tib[$i]->status_aktif==1) echo "Aktif"; else echo "Tidak Aktif";?></td>
                  <td style="width:10%"><?php echo $tib[$i]->email?></td>
                  <td style="width:13%" class="text-center">
                                        <button type="button" class="btn btn-warning btn-xs table-hover" data-toggle="modal"  data-target="#<?php echo $tib[$i]->nopeg?>">Edit</button>
                                        <?=anchor( 'admin/delete_tib/' . $tib[$i]->nopeg,
                                       'Delete',
                                       ...
                                       'onclick'=>'return confirm(\'Apakah Anda Yakin?\')'
                                                    ...
                                                    if($this->input->post('is_submitted')){
                                                                ...
                                                                $posisi         = $tib[$i]->posisi;
                                                                $nama           = $tib[$i]->nama;
                                                                $direktorat     = $tib[$i]->direktorat;
                                                                $status_aktif   = $tib[$i]->status_aktif;
                                                                $email          = $tib[$i]->email;
                                                    }
                                                    ?>
                                                        <!-- Modal -->
                                                      ...
                                                      <div class="modal-dialog modal-lg" role="document">
                                                        <div class="modal-content">
                                                          ...
                                                          <div class="modal-body">
                                                                <!-- Isi Modal -->
                                                                <div class="box-body">
                                                                <?php echo form_open_multipart('admin/edit_tib/' .$id)?>
                                                                <div class="row">
                                                                  <div class="col-md-3">
                                                                  ...
                                                                  <div class="col-md-3">
                                                                    <div class="form-group">
                                                                      <h5>Unit</h5>
                                                                      <input type="text" name="posisi" class="form-control" autocomplete="off" required value="<?=$posisi?>">
                                                                    </div>
                                                                  </div>
                                                                  <div class="col-md-3">
                                                                    <div class="form-group">
    ...
    <script>
        $(document).ready(function(){
            $('.dataTables-example').DataTable({
                ...
                buttons: [
                    {extend: 'csv'},
                    {extend: 'excel', title: 'List Tim Implementasi Budaya'},
                    {extend: 'pdf', title: 'List Tim Implementasi Budaya'},
